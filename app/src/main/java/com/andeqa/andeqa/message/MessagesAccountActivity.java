...
public class MessagesAccountActivity extends AppCompatActivity
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_view_profile){
            Intent intent = new Intent(MessagesAccountActivity.this, ProfileActivity.class);
            intent.putExtra(MessagesAccountActivity.EXTRA_USER_UID, mUid);
...
//            bundle.putString(MessagesAccountActivity.EXTRA_USER_UID, mUid);
//            bundle.putString(MessagesAccountActivity.CLEAR_MESSAGES, mUid);
...
//        }
    ...
    public void onClick(View v){
        if (v==mGalleryImageView){
            Intent intent = new Intent(MessagesAccountActivity.this, PicturesActivity.class);
            intent.putExtra(MessagesAccountActivity.EXTRA_USER_UID, mUid);
            intent.putExtra(MessagesAccountActivity.EXTRA_ROOM_ID, roomId);
            startActivity(intent);
            finish();
        }
            ...
            Task<Uri> urlTask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                ...
                public void onComplete(@NonNull Task<Uri> task) {
                    if (task.isSuccessful()) {
                        ...
                        message.setPhoto(downloadUri.toString());
                        senderRef.set(message);
                        receiverRef.set(message);
                        ...
                        senderReference.set(room);
//
//                        Intent intent = new Intent(MessagesAccountActivity.this, MessagesAccountActivity.class);
//                        intent.putExtra(MessagesAccountActivity.EXTRA_USER_UID, mUid);
//                        intent.putExtra(MessagesAccountActivity.EXTRA_ROOM_ID, roomId);
//                        startActivity(intent);
                ...
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(MessagesAccountActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                }
            });
