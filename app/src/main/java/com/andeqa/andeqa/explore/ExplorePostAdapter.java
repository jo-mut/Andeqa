...
public class ExplorePostAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>
    ...
    public ExplorePostAdapter(Activity activity) {
        ...
        if (post.getWidth() != null && post.getHeight() != null){
            holder.postImageView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    intent.putExtra(ExplorePostAdapter.EXTRA_USER_UID, uid);
                    intent.putExtra(ExplorePostAdapter.TYPE, type);
                    intent.putExtra(ExplorePostAdapter.POST_HEIGHT, post.getHeight());
                    intent.putExtra(ExplorePostAdapter.POST_WIDTH, post.getWidth());
                    mContext.startActivity(intent);
                }
            });
        }else {
