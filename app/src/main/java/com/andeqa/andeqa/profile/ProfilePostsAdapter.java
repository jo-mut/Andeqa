...
public class ProfilePostsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>
    ...
    public ProfilePostsAdapter(Activity activity) {
...
//                   //clear the exoplayer player
//                   holder.postVideoView.getPlayer().setPlayWhenReady(false);
//                   holder.postVideoView.getPlayer().release();
//                   holder.postVideoView.setPlayer(null);
//                   //play the video after the previous player has been cleared
//                   holder.postVideoView.getPlayer().setPlayWhenReady(true);
//                   holder.puaseImageView.setVisibility(View.VISIBLE);
                }
            }
        ...
        if (!TextUtils.isEmpty(post.getDescription())){
            ...
            if (size <= 50){
                ...
                String normalText = post.getDescription().substring(0, 50);
        ...
        if (post.getWidth() != null && post.getHeight() != null){
            holder.postImageView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    intent.putExtra(ProfilePostsAdapter.EXTRA_USER_UID, uid);
                    intent.putExtra(ProfilePostsAdapter.TYPE, type);
                    intent.putExtra(ProfilePostsAdapter.POST_HEIGHT, post.getHeight());
                    intent.putExtra(ProfilePostsAdapter.POST_WIDTH, post.getWidth());
                    mContext.startActivity(intent);
                }
            });
        }else {
...
//                });
        ...
        collectionPostReference.document(collectionId)
                        ...
                        if (documentSnapshot.exists()){
                            ...
                            holder.collectionNameTextView.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    ...
                                    intent.putExtra(ProfilePostsAdapter.COLLECTION_ID, collectionId);
                                    intent.putExtra(ProfilePostsAdapter.EXTRA_USER_UID, creatorUid);
                                    mContext.startActivity(intent);
                                }
                            });
                        }
