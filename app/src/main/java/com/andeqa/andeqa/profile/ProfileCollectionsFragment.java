 ...
 */
public class ProfileCollectionsFragment extends Fragment implements
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_profile_collections, container, false);
        ...
        if (firebaseAuth.getCurrentUser()!= null){
            ...
            collectionsCollection.addSnapshotListener(new EventListener<QuerySnapshot>() {
                @Override
                public void onEvent(@Nullable QuerySnapshot queryDocumentSnapshots, @Nullable FirebaseFirestoreException e) {
                    ...
                    if (queryDocumentSnapshots.isEmpty()){
                        Log.d("collections absent", "collections absent");
                    }else {
                        Log.d("collections present", queryDocumentSnapshots.size() + "");
                    }
                }
            });
        ...
        collectionsQuery.addSnapshotListener(new EventListener<QuerySnapshot>() {
            ...
            public void onEvent(QuerySnapshot documentSnapshots, FirebaseFirestoreException e) {
                ...
                if (!documentSnapshots.isEmpty()){
                    ...
                    Log.d("collections", "data is present");
