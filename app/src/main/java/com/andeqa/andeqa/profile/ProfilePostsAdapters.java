...
public class ProfilePostsAdapters extends RecyclerView.Adapter<RecyclerView.ViewHolder>
        implements ImpressionTracker.VisibilityTrackerListener{
    private static final String TAG = ProfilePostsAdapters.class.getSimpleName();
    ...
    public ProfilePostsAdapters(Activity activity) {
    ...
    public void setCollectionPosts(List<DocumentSnapshot> mSnapshots){
    ...
    private void populateVideo(final VideoPostViewHolder holder, final int position){
        ...
        holder.postVideoView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra(ProfilePostsAdapters.EXTRA_POST_ID, postId);
                intent.putExtra(ProfilePostsAdapters.COLLECTION_ID, collectionId);
                intent.putExtra(ProfilePostsAdapters.EXTRA_USER_UID, uid);
                intent.putExtra(ProfilePostsAdapters.TYPE, type);
        ...
        if (post.getWidth() != null && post.getHeight() != null){
            holder.postImageView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    intent.putExtra(ProfilePostsAdapters.EXTRA_USER_UID, uid);
                    intent.putExtra(ProfilePostsAdapters.TYPE, type);
                    intent.putExtra(ProfilePostsAdapters.POST_HEIGHT, post.getHeight());
                    intent.putExtra(ProfilePostsAdapters.POST_WIDTH, post.getWidth());
                    mContext.startActivity(intent);
                }
            });
        }else {
