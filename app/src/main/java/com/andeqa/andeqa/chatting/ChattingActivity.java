...
import com.andeqa.andeqa.models.Chat;
...
//                        setNextMessages();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_view_profile){
            Intent intent = new Intent(ChattingActivity.this, ProfileActivity.class);
            intent.putExtra(ChattingActivity.EXTRA_USER_UID, mUid);
...
//        }
    ...
    public void onClick(View v){
        if (v==mGalleryImageView){
            Intent intent = new Intent(ChattingActivity.this, PicturesActivity.class);
            intent.putExtra(ChattingActivity.EXTRA_USER_UID, mUid);
            intent.putExtra(ChattingActivity.EXTRA_ROOM_ID, roomId);
            startActivity(intent);
            finish();
        }
