...
public class ViewMessagePhoto extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_message_photo);
        ...
        messageCollection.document(firebaseAuth.getCurrentUser().getUid())
            ...
            public void onEvent(DocumentSnapshot documentSnapshot, FirebaseFirestoreException e) {
                ...
                if (documentSnapshot.exists()){
                    ...
                    Picasso.with(ViewMessagePhoto.this)
                            .load(image)
