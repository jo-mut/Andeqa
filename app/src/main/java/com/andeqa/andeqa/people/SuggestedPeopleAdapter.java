...
public class SuggestedPeopleAdapter extends RecyclerView.Adapter<SuggestedPeopleViewHolder> {
    private static final String TAG = SuggestedPeopleAdapter.class.getSimpleName();
    //context
    ...
    @Override
    public SuggestedPeopleViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_follow_user, parent, false);
        return new SuggestedPeopleViewHolder(view);
    }
    ...
    @Override
    public void onBindViewHolder(final SuggestedPeopleViewHolder holder, int position) {
        ...
        holder.mBioTextView.setText(bio);
        ...
        if (profileImage != null && profileCover == null){
            ...
            holder.mBioTextView.setTextColor(Color.WHITE);
            holder.profileCoverRelativeLayout.setBackgroundResource(R.drawable.default_gradient_color);
            Glide.with(context.getApplicationContext())
                    .load(profileImage)
                    .apply(new RequestOptions()
            ...
            holder.mBioTextView.setTextColor(Color.BLACK);
            holder.profileCoverRelativeLayout.setBackgroundResource(R.drawable.transparent_background);
            Glide.with(context.getApplicationContext())
                    .load(profileCover)
                    .apply(new RequestOptions()
                            .placeholder(R.drawable.post_placeholder)
        ...
        holder.profileImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra(SuggestedPeopleAdapter.EXTRA_USER_UID, userId);
