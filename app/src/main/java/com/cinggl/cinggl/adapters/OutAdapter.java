...
import com.cinggl.cinggl.viewholders.OutViewHolder;
...
/**
 * Created by J.EL on 11/25/2017.
 */

public class OutAdapter extends FirestoreAdapter<OutViewHolder> {
    private static final String TAG =  OutAdapter.class.getSimpleName();
    ...
    public OutAdapter(Query query, Context mContext) {
        super(query);
    ...
    public OutViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new OutViewHolder(inflater.inflate(R.layout.single_out_list, parent, false));
    }
    ...
    @Override
    public void onBindViewHolder(final OutViewHolder holder, int position) {
        ...
        holder.likesCountTextView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra(OutAdapter.EXTRA_POST_KEY, postKey);
        ...
        holder.cingleSettingsImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                bundle.putString(OutAdapter.EXTRA_POST_KEY, postKey);
        ...
        holder.profileImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if ((firebaseAuth.getCurrentUser().getUid()).equals(uid)){
                    ...
                    intent.putExtra(OutAdapter.EXTRA_USER_UID, uid);
                    mContext.startActivity(intent);
