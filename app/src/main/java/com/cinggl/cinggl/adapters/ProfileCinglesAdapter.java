...
/**
 * Created by J.EL on 9/2/2017.
 */

public class ProfileCinglesAdapter extends RecyclerView.Adapter<ProfileCinglesViewHolder> {
    private static final String TAG =  ProfileCinglesAdapter.class.getSimpleName();
    private List<Cingle> profileCingles = new ArrayList<>();
    ...
    public void setProfileCingles(List<Cingle> profileCingles) {
        this.profileCingles = profileCingles;
        notifyDataSetChanged();
    }

    public void removeAt(int position){
        profileCingles.remove(profileCingles.get(position));
    }


    public void animate(ProfileCinglesViewHolder viewHolder){
    ...
    public ProfileCinglesViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        ProfileCinglesViewHolder profileCinglesViewHolder = new ProfileCinglesViewHolder(view);
        return profileCinglesViewHolder;
    }

    @Override
    public void onBindViewHolder(final ProfileCinglesViewHolder holder, final int position) {
        final Cingle cingle = profileCingles.get(position);
        holder.bindProfileCingle(cingle);
        final String postKey = profileCingles.get(position).getPushId();
                ...
                holder.profileImageView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        if ((firebaseAuth.getCurrentUser().getUid()).equals(uid)){
                            ...
                            intent.putExtra(ProfileCinglesAdapter.EXTRA_USER_UID, uid);
                            mContext.startActivity(intent);
