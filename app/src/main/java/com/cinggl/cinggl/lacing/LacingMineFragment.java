 ...
 */
public class LacingMineFragment extends Fragment {
    //bind views
    @Bind(R.id.mineLacedCinglesRecyclerView)RecyclerView mMineLacedCinglesRecyclerView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_lacing_mine, container, false);
    ...
    public void setUpLacedCingles(){
        overallQuery = lacingOverallReferences.child("Cingle Lacing").orderByChild("creator");
        ...
        mMineLacedCinglesRecyclerView.setLayoutManager(layoutManager);
        mMineLacedCinglesRecyclerView.setHasFixedSize(true);
        mMineLacedCinglesRecyclerView.setAdapter(firebaseRecyclerAdapter);
    }
