 ...
 */
public class BackingMineFragment extends Fragment {

    //bind views
    @Bind(R.id.mineBackingCinglesRecyclerView)RecyclerView mMineBackingCinglesRecyclerView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_backing_mine, container, false);
    ...
    public void setUpLacedCingles(){
        overallQuery = lacingOverallReferences.child("Cingle Backing").orderByChild("creator");
        ...
        mMineBackingCinglesRecyclerView.setLayoutManager(layoutManager);
        mMineBackingCinglesRecyclerView.setHasFixedSize(true);
        mMineBackingCinglesRecyclerView.setAdapter(firebaseRecyclerAdapter);
    }
