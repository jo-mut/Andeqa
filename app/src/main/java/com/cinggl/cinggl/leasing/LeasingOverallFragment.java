 ...
 */
public class LeasingOverallFragment extends Fragment {
    //bind views
    @Bind(R.id.overallLeasingCinglesRecyclerView)RecyclerView mOverallLeasingCinglesRecyclerView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_leasing_overall, container, false);
        ButterKnife.bind(this, view);

        //intialize database references;
        lacingOverallReferences = FirebaseDatabase.getInstance().getReference(Constants.IFAIR);
        overallQuery = lacingOverallReferences.child("Cingle Leasing").orderByChild("pushId");
    ...
    public void setUpLacedCingles(){
        ...
        mOverallLeasingCinglesRecyclerView.setLayoutManager(layoutManager);
        mOverallLeasingCinglesRecyclerView.setHasFixedSize(true);
        mOverallLeasingCinglesRecyclerView.setAdapter(firebaseRecyclerAdapter);
    }
