 ...
 */
public class SellingMineFragment extends Fragment {

    //bind views
    @Bind(R.id.mineSellingCinglesRecyclerView)RecyclerView mMineSellingCinglesRecyclerView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_selling_mine, container, false);
    ...
    public void setUpLacedCingles(){
        overallQuery = lacingOverallReferences.child("Cingle Selling").orderByChild("creator");
        ...
        mMineSellingCinglesRecyclerView.setLayoutManager(layoutManager);
        mMineSellingCinglesRecyclerView.setHasFixedSize(true);
        mMineSellingCinglesRecyclerView.setAdapter(firebaseRecyclerAdapter);
    }
