...
public class ChooseTradeMethodActivity extends AppCompatActivity{
//    //BIND VIEWS
...
//                            @Override
//                            public void onDataChange(DataSnapshot dataSnapshot) {
//                                if (!dataSnapshot.child("Cingle Backing").hasChild(mPostKey) &&
//                                        !dataSnapshot.child("Cingle Lacing").hasChild(mPostKey) &&
//                                        !dataSnapshot.child("Cingle Leasing").hasChild(mPostKey)){
//
...
//                                    Toast.makeText(ChooseTradeMethodActivity.this, "Your cingle has been listed on Ifair",
//                                            Toast.LENGTH_LONG).show();
//                                }else {
//                                    if (dataSnapshot.child("Cingle Backing").hasChild(mPostKey)){
//                                        Toast.makeText(ChooseTradeMethodActivity.this, "Sorry! This Cingle is already backed",
//                                                Toast.LENGTH_LONG).show();
//                                        mCingleSellingRadioButton.setChecked(false);
//                                    }else if (dataSnapshot.child("Cingle Lacing").hasChild(mPostKey)){
//                                        Toast.makeText(ChooseTradeMethodActivity.this, "Sorry! This Cingle is already laced",
//                                                Toast.LENGTH_LONG).show();
//                                        mCingleSellingRadioButton.setChecked(false);
//                                    }else if (dataSnapshot.child("Cingle Leasing").hasChild(mPostKey)){
//                                        Toast.makeText(ChooseTradeMethodActivity.this, "Sorry! This Cingle is already leased",
//                                                Toast.LENGTH_LONG).show();
//                                        mCingleSellingRadioButton.setChecked(false);
//                                    }else if (dataSnapshot.child("Cingle Selling").hasChild(mPostKey)){
//                                        Toast.makeText(ChooseTradeMethodActivity.this, "Sorry! This Cingle is already on sale",
//                                                Toast.LENGTH_LONG).show();
//                                        mCingleSellingRadioButton.setChecked(false);
//                                    }else {
//                                        Log.d("this Cingle posted", mPostKey);
//                                    }
//                                }
//                            }
//
...
//                            public void onDataChange(DataSnapshot dataSnapshot) {
//                                if (!dataSnapshot.child("Cingle Backing").hasChild(mPostKey) &&
//                                        !dataSnapshot.child("Cingle Selling").hasChild(mPostKey) &&
//                                        !dataSnapshot.child("Cingle Leasing").hasChild(mPostKey)){
//
//                                    Ifair ifair =  new Ifair();
//                                    ifair.setCreator(firebaseAuth.getCurrentUser().getUid());
...
//                            @Override
//                            public void onDataChange(DataSnapshot dataSnapshot) {
//                                if (!dataSnapshot.child("Cingle Leasing").hasChild(mPostKey) &&
//                                        !dataSnapshot.child("Cingle Selling").hasChild(mPostKey) &&
//                                        !dataSnapshot.child("Cingle Lacing").hasChild(mPostKey)){
//
//                                    Ifair ifair =  new Ifair();
