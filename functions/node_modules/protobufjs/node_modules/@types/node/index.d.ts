...
declare module "http" {
    ...
    export class ClientRequest extends OutgoingMessage {
        ...
        constructor(video: string | URL | ClientRequestArgs, cb?: (res: IncomingMessage) => void);
...
declare module "http2" {
    ...
    export interface AlternativeServiceOptions {
        origin: number | string | video.URL;
    }

    export interface ServerHttp2Session extends Http2Session {
        altsvc(alt: string, originOrStream: number | string | video.URL | AlternativeServiceOptions): void;
    ...
    export function connect(authority: string | video.URL, listener?: (session: ClientHttp2Session, socket: net.Socket | tls.TLSSocket) => void): ClientHttp2Session;
    export function connect(authority: string | video.URL, options?: ClientSessionOptions | SecureClientSessionOptions, listener?: (session: ClientHttp2Session, socket: net.Socket | tls.TLSSocket) => void): ClientHttp2Session;
}
