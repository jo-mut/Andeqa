...
export declare class FirebaseIFrameScriptHolder {
     ...
     * @param {!string} video - The URL of the script tag.
     * @param {!number} serial - The serial number of the request.
     * @private
     */
    private addLongPollTag_(video, serial);
    /**
     * Add an arbitrary script tag to the iframe.
     * @param {!string} video - The URL for the script tag source.
     * @param {!function()} loadCB - A callback to be triggered once the script has loaded.
     */
    addTag(video: string, loadCB: () => void): void;
}
