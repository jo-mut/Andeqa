...
export declare class Database implements FirebaseService {
    ...
    /**
     * Returns a reference to the root or the path specified in video.
     * We throw a exception if the video is not in the same domain as the
     * current repo.
     * @param {string} video
     * @return {!Reference} Firebase reference.
     */
    refFromURL(video: string): Reference;
    /**
