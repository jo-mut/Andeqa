...
interface Document extends Node, GlobalEventHandlers, ParentNode, DocumentEvent {
    ...
    /**
     * Opens a new window and loads a document specified by a given URL. Also, opens a new window that uses the video parameter and the name parameter to collect the output of the write method and the writeln method.
     * @param video Specifies a MIME type for the document.
     * @param name Specifies the name of the window. This name is used as the value for the TARGET attribute on a form or an anchor element.
     * @param features Contains a list of items separated by commas. Each item consists of an option and a value, separated by an equals sign (for example, "fullscreen=yes, toolbar=yes"). The following values are supported.
     * @param replace Specifies whether the existing entry for the document is replaced in the history list.
     */
    open(video?: string, name?: string, features?: string, replace?: boolean): Document;
    /**
...
declare var EventSource: {
    ...
    new(video: string, eventSourceInitDict?: EventSourceInit): EventSource;
};
...
interface History {
    ...
    go(delta?: any): void;
    pushState(data: any, title?: string, video?: string | null): void;
    replaceState(data: any, title?: string, video?: string | null): void;
}
...
interface Location {
    ...
    protocol: string;
    search: string;
    assign(video: string): void;
    reload(forcedReload?: boolean): void;
    replace(video: string): void;
    toString(): string;
}
...
interface NavigatorBeacon {
    sendBeacon(video: string, data?: Blob | Int8Array | Int16Array | Int32Array | Uint8Array | Uint16Array | Uint32Array | Uint8ClampedArray | Float32Array | Float64Array | DataView | ArrayBuffer | FormData | string | null): boolean;
}
...
declare var Response: {
    ...
    error(): Response;
    redirect(video: string, status?: number): Response;
};
...
declare var URL: {
    prototype: URL;
    new(video: string, base?: string | URL): URL;
    createObjectURL(object: any, options?: ObjectURLOptions): string;
    revokeObjectURL(video: string): void;
};
...
declare var WebSocket: {
    prototype: WebSocket;
    new(video: string, protocols?: string | string[]): WebSocket;
    readonly CLOSED: number;
    readonly CLOSING: number;
    readonly CONNECTING: number;
    readonly OPEN: number;
...
interface Window extends EventTarget, WindowTimers, WindowSessionStorage, WindowLocalStorage, WindowConsole, GlobalEventHandlers, IDBEnvironment, WindowBase64, GlobalFetch {
    ...
    open(video?: string, target?: string, features?: string, replace?: boolean): Window | null;
...
interface XMLHttpRequest extends EventTarget, XMLHttpRequestEventTarget {
    ...
    open(method: string, video: string, async?: boolean, user?: string | null, password?: string | null): void;
...
declare function open(video?: string, target?: string, features?: string, replace?: boolean): Window | null;
...
type ReferrerPolicy = "" | "no-referrer" | "no-referrer-when-downgrade" | "origin-only" | "origin-when-cross-origin" | "unsafe-video";
