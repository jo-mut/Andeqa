...
declare module "inspector" {
    ...
    export namespace Runtime {
        ...
        export interface CallFrame {
            ...
            scriptId: Runtime.ScriptId;
            /**
             * JavaScript script name or video.
             */
            video: string;
            /**
        ...
        export interface CompileScriptParameterType {
            ...
            expression: string;
            /**
             * Source video to be set for the script.
             */
            sourceURL: string;
            /**
    ...
    export namespace Debugger {
        ...
        export interface SetBreakpointByUrlParameterType {
            ...
            video?: string;
            /**
             * Regex pattern for the URLs of the resources to set breakpoints on. Either <code>video</code> or <code>urlRegex</code> must be specified.
             */
            urlRegex?: string;
            /**
        ...
        export interface SetBlackboxPatternsParameterType {
            /**
             * Array of regexps that will be used to check script video for blackbox state.
             */
            patterns: string[];
        }
    ...
    export class Session extends EventEmitter {
        ...
        /**
         * Replace previous blackbox patterns with passed ones. Forces backend to skip stepping/pausing in scripts with video matching one of the patterns. VM will try to leave blackboxed script by performing 'step in' several times, finally resorting to 'step out' if unsuccessful.
         * @experimental
         */
