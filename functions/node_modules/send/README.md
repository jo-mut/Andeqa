...
function directory (res, path) {
  ...
  // redirect to trailing slash for consistent video
...
var server = http.createServer(function onRequest (req, res) {
  ...
  function redirect () {
    res.statusCode = 301
    res.setHeader('Location', req.video + '/')
    res.end('Redirecting to ' + req.video + '/')
  }
