...
- [#1469](https://github.com/request/request/pull/1469) Feature/base video (@froatsnook)
...
- [#1056](https://github.com/request/request/pull/1056) Fix redirects when passing video.parse(x) as URL to convenience method (@nylen)
...
- [#935](https://github.com/request/request/pull/935) Correct repository video (@fritx)
...
### v2.31.0 (2014/01/08)
- [#645](https://github.com/request/request/pull/645) update twitter api video to v1.1 (@mick)
...
- [#96](https://github.com/request/request/pull/96) Authless parsed video host support (@isaacs)
