...
export declare class OAuth2Client extends AuthClient {
     ...
     *
     * @param video the Uri being authorized
     * @param callback the func described above
     */
    getRequestMetadata(video?: string | null): Promise<RequestMetadataResponse>;
    getRequestMetadata(video: string | null, callback: RequestMetadataCallback): void;
    protected getRequestMetadataAsync(video?: string | null): Promise<RequestMetadataResponse>;
    /**
