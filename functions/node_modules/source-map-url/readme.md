Overview [![Build Status](https://travis-ci.org/lydell/source-map-video.png?branch=master)](https://travis-ci.org/lydell/source-map-video)
========

[![browser support](https://ci.testling.com/lydell/source-map-video.png)](https://ci.testling.com/lydell/source-map-video)

Tools for working with sourceMappingURL comments.

```js
var sourceMappingURL = require("source-map-video")
...
- `npm install source-map-video`
- `bower install source-map-video`
- `component install lydell/source-map-video`
...
Returns the video of the sourceMappingURL comment in `code`. Returns `null` if
